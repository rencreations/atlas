    ...
    extend: {
      colors: {
        ...
        brand: {
          ...
          'blue-vivid': 'rgb(var(--brand-blue-vivid) / <alpha-value>)',
          'yellow-vivid': 'rgb(var(--brand-yellow-vivid) / <alpha-value>)',
          'red-vivid': 'rgb(var(--brand-red-vivid) / <alpha-value>)',
          'green-vivid': 'rgb(var(--brand-green-vivid) / <alpha-value>)',
        },
