...
export const apiPaths = {
  ...
  auth: {
    ...
    inviteCheck: () => '/auth/register/invite/check',
  ...
  godmode: {
    ...
    deleteUser: (id: string) => `/godmode/users/${id}`,
    suspendUser: (id: string) => `/godmode/users/${id}/suspend`,
    unsuspendUser: (id: string) => `/godmode/users/${id}/unsuspend`,
    resetUserPassword: (id: string) => `/godmode/users/${id}/password`,
    revokeUserSessions: (id: string) => `/godmode/users/${id}/sessions/revoke`,
